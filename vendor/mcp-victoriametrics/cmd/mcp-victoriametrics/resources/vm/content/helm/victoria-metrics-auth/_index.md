...
<table class="helm-vars">
  ...
  <tbody>
    ...
    <tr id="secretname">
      ...
      <td><em><code>(string)</code></em><p>Use existing secret if specified otherwise .config values will be used. Check <a href="https://docs.victoriametrics.com/victoriametrics/vmauth/" target="_blank">here</a> for details. Configuration in the given secret must be stored under <code>auth.yml</code> key.</p>
</td>
    </tr>
