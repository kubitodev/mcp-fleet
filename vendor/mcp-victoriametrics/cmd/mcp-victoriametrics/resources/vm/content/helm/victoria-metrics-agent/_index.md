...
url: /helm/victoria-metrics-agent/
aliases:
...
<table class="helm-vars">
  ...
  <tbody>
...
</span></span></span><span class="line"><span class="cl"><span class="w">    </span><span class="nt">useTpl</span><span class="p">:</span><span class="w"> </span><span class="kc">false</span></span></span></code></pre>
</a></td>
      <td><em><code>(object)</code></em><p>VMAgent scrape configuration</p>
</td>
    </tr>
    <tr id="config-usetpl">
      <td><a href="#config-usetpl"><pre class="chroma"><code><span class="line"><span class="cl"><span class="nt">config.useTpl</span><span class="p">:</span><span class="w"> </span><span class="kc">false</span></span></span></code></pre>
</a></td>
      <td><em><code>(bool)</code></em><p>Enable config templating</p>
</td>
    </tr>
    <tr id="configmap">
      ...
      <td><em><code>(string)</code></em><p>VMAgent <a href="https://docs.victoriametrics.com/victoriametrics/vmagent/#how-to-collect-metrics-in-prometheus-format" target="_blank">scraping configuration</a> use existing configmap if specified otherwise .config values will be used</p>
</td>
    </tr>
    ...
    <tr id="env">
      ...
      <td><em><code>(list)</code></em><p>Additional environment variables (ex.: secret tokens, flags). Check <a href="https://docs.victoriametrics.com/victoriametrics/#environment-variables" target="_blank">here</a> for more details.</p>
</td>
    </tr>
    <tr id="envfrom">
    ...
    <tr id="horizontalpodautoscaling">
      ...
      <td><em><code>(object)</code></em><p>Horizontal Pod Autoscaling. Note that it is not intended to be used for vmagents which perform scraping. In order to scale scraping vmagents check <a href="https://docs.victoriametrics.com/victoriametrics/vmagent/#scraping-big-number-of-targets" target="_blank">here</a></p>
</td>
    </tr>
    ...
    <tr id="hostaliases">
      <td><a href="#hostaliases"><pre class="chroma"><code><span class="line"><span class="cl"><span class="nt">hostAliases</span><span class="p">:</span><span class="w"> </span><span class="p">[]</span></span></span></code></pre>
</a></td>
      <td><em><code>(list)</code></em><p>Add additional DNS entries to pods hosts file. Check <a href="https://kubernetes.io/docs/tasks/network/customize-hosts-file-for-pods/" target="_blank">official documentation</a></p>
</td>
    </tr>
    <tr id="hostnetwork">
      ...
      <td><em><code>(bool)</code></em><p>Enable the host network</p>
</td>
    </tr>
    ...
    <tr id="rbac-extrarules">
      <td><a href="#rbac-extrarules"><pre class="chroma"><code><span class="line"><span class="cl"><span class="nt">rbac.extraRules</span><span class="p">:</span><span class="w"> </span><span class="p">[]</span></span></span></code></pre>
</a></td>
    ...
    <tr id="selectorlabels">
      <td><a href="#selectorlabels"><pre class="chroma"><code><span class="line"><span class="cl"><span class="nt">selectorLabels</span><span class="p">:</span><span class="w"> </span>{}</span></span></code></pre>
</a></td>
      <td><em><code>(object)</code></em><p>Extra selector labels common for pod and service</p>
</td>
    </tr>
    ...
    <tr id="service-internaltrafficpolicy">
      <td><a href="#service-internaltrafficpolicy"><pre class="chroma"><code><span class="line"><span class="cl"><span class="nt">service.internalTrafficPolicy</span><span class="p">:</span><span class="w"> </span><span class="s2">&#34;&#34;</span></span></span></code></pre>
</a></td>
      <td><em><code>(string)</code></em><p>Service internal traffic policy. Check <a href="https://kubernetes.io/docs/concepts/services-networking/service/#internal-traffic-policy" target="_blank">here</a> for details</p>
</td>
    </tr>
    ...
    <tr id="service-selectorlabels">
      <td><a href="#service-selectorlabels"><pre class="chroma"><code><span class="line"><span class="cl"><span class="nt">service.selectorLabels</span><span class="p">:</span><span class="w"> </span>{}</span></span></code></pre>
</a></td>
      <td><em><code>(object)</code></em><p>Extra selector labels common for service only</p>
</td>
    </tr>
    ...
    <tr id="statefulset-clustermode">
      ...
      <td><em><code>(bool)</code></em><p>create cluster of vmagents. Check <a href="https://docs.victoriametrics.com/victoriametrics/vmagent/#scraping-big-number-of-targets" target="_blank">here</a> available since <a href="https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v1.77.2" target="_blank">v1.77.2</a></p>
</td>
    </tr>
