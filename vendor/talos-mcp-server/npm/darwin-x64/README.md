# @talos-mcp/darwin-x64

The macOS x86-64 (`darwin` / `x64`) binary distribution of [`talos-mcp`](https://www.npmjs.com/package/talos-mcp), an MCP server for Talos Linux cluster management via the native gRPC API.
