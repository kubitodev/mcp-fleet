# @talos-mcp/darwin-arm64

The macOS ARM64 (Apple Silicon) (`darwin` / `arm64`) binary distribution of [`talos-mcp`](https://www.npmjs.com/package/talos-mcp), an MCP server for Talos Linux cluster management via the native gRPC API.
